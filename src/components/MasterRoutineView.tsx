...
export const MasterRoutineView: React.FC = () => {
  ...
  const getRecurrenceBadge = (routine: MasterRoutineItem) => {
    switch (routine.recurrence) {
      case 'daily':
        return { label: 'Every Day', class: 'bg-emerald-50 text-emerald-800 border-emerald-200' };
      case 'weekdays':
        return { label: 'Weekdays (M-F)', class: 'bg-blue-50 text-blue-800 border-blue-200' };
      case 'weekends':
        return { label: 'Weekends (Sat-Sun)', class: 'bg-purple-50 text-purple-800 border-purple-200' };
      case 'custom':
        return {
